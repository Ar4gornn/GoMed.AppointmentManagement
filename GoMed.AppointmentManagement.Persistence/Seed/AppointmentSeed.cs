// GoMed.AppointmentManagement.Persistence/Seed/AppointmentSeed.cs
        ...
        public static List<Appointment> GetAppointments()
        {
            return new List<Appointment>
            {
                new Appointment
                {
                    ...
                    ProfessionalId = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), // Matches a Professional
                    ClinicId = Guid.Parse("1a2b3c4d-5e6f-7a8b-9c0d-1e2f3a4b5c6d"),     // Matches a Clinic
                    PatientId = Guid.Parse("44444444-4444-4444-4444-444444444444"),     // Add to PatientSeed
